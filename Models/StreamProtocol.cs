...
public sealed class DeckLinkStandardItem
{
    ...
    {
        new() { Code = "Hi50", DisplayName = "1080i50 (Hi50) PAL", Width = 1920, Height = 1080, FrameRate = 25.0, IsInterlaced = true },
        new() { Code = "Hp50", DisplayName = "1080p50 (Hp50)", Width = 1920, Height = 1080, FrameRate = 50.0, IsInterlaced = false },
        new() { Code = "Hp25", DisplayName = "1080p25 (Hp25)", Width = 1920, Height = 1080, FrameRate = 25.0, IsInterlaced = false },
        new() { Code = "Hi59", DisplayName = "1080i59.94 (Hi59)", Width = 1920, Height = 1080, FrameRate = 29.97, IsInterlaced = true },
        new() { Code = "Hp60", DisplayName = "1080p60 (Hp60)", Width = 1920, Height = 1080, FrameRate = 60.0, IsInterlaced = false },
        new() { Code = "Hp30", DisplayName = "1080p30 (Hp30)", Width = 1920, Height = 1080, FrameRate = 30.0, IsInterlaced = false },
        new() { Code = "hp50", DisplayName = "720p50 (hp50)", Width = 1280, Height = 720, FrameRate = 50.0, IsInterlaced = false },
        new() { Code = "hp60", DisplayName = "720p60 (hp60)", Width = 1280, Height = 720, FrameRate = 60.0, IsInterlaced = false },
        new() { Code = "pal ", DisplayName = "576i50 PAL (pal )", Width = 720, Height = 576, FrameRate = 25.0, IsInterlaced = true },
        new() { Code = "ntsc", DisplayName = "480i60 NTSC (ntsc)", Width = 720, Height = 480, FrameRate = 29.97, IsInterlaced = true },
        new() { Code = "auto", DisplayName = "Auto Detect", Width = 1920, Height = 1080, FrameRate = 25.0, IsInterlaced = false }
    };
}
